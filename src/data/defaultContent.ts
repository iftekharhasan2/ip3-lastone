...
export const defaultSystemsHero: SystemsHeroSectionData = {
  ...
  titleHighlight: 'complexity of now.',
  description:
    'IP3 Consulting Limited translates policy intelligence, data, and digital transformation into implementation architecture for resilient institutions, inclusive systems, and a sustainable, equitable future.',
